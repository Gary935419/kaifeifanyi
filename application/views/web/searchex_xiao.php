...
<div class="max">
	...
	<div class="mcenter">
		<div class="searchex_xiaoliat">
    		...
    		<?php } ?>
    			<?php if (empty($ltype)){ ?>
    			<a href="<?= RUN . '/webviews/searchex_xiao?ltype=2&id=' . $id ?>" class="search_login">
    				<span>英文</span>
    			</a>
    		<?php }else{ ?>
    			<a href="<?= RUN . '/webviews/searchex_xiao?ltype=1&id=' . $id ?>" class="search_login">
    				<span>Chinese</span>
    			</a>
    		<?php } ?>
    	</div>
				...
				<div class="spsearchex_yuan_sp">
					<div class="spsearchex_yuan_sp_block">
						...
						<div class="spsearchex_yuan_sp_area">
							<span class="spsearchex_yuan_sp_name"><?php echo $yuyan2['text11'] ?></span>
							<div class="searchex_yuan_top_box">
								...
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text9'] ?>：</span>
									<span class="searchex_yuan_top_caption"><?php echo $data['dianhua'] ?></span>
								</div>
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text10'] ?>：</span>
									<span class="searchex_yuan_top_caption"><?php echo $data['youxiang'] ?></span>
								</div>
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text15'] ?>：</span>
									<span class="searchex_yuan_top_caption"><?php echo $data['xinghao'] ?></span>
								</div>
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text16'] ?>：</span>
									<span class="searchex_yuan_top_caption"><?php echo $data['caigouliang'] ?></span>
								</div>
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text17'] ?>：</span>
									<span class="searchex_yuan_top_caption"><?php echo $data['caigoushijian'] ?></span>
								</div>
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text18'] ?>：</span>
									<span class="searchex_yuan_top_caption"><?php echo $data['chulitedian']  ?></span>
								</div>
								<div class="searchex_yuan_top_info">
									<span class="searchex_yuan_top_name"><?php echo $yuyan2['text14'] ?>：</span>
							...
							<div class="searchex_yuan_area" id="a1">
								<div class="searchex_yuan_center_title">
									<span class="searchex_yuan_name"><?php echo $yuyan2['text21'] ?></span>
							...
							<div class="searchex_yuan_area" id="a2">
								<div class="searchex_yuan_center_title">
									<span class="searchex_yuan_name"><?php echo $yuyan2['text22'] ?></span>
									<span class="searchex_yuan_xian"></span>
								</div>
								<div class="searchex_yuan_box">
					...
					<div class="spsearchex_yuan_sp_menumodel">
						<div class="spsearchex_yuan_sp_menusection">
							...
							<div class="spsearchex_yuan_sp_menuarea">
								<a href="#a1" class="spsearchex_yuan_sp_menulink spsearchex_yuan_sp_menuon">1、<?php echo $yuyan2['text21'] ?></a>
								<a href="#a2" class="spsearchex_yuan_sp_menulink">2、<?php echo $yuyan2['text22'] ?></a>
							</div>
					...
					<div class="searchex_yuan_center">
						...
						<div class="searchex_yuan_fixed">
							...
							<div class="searchex_yuan_fixed_box">
								<a href="#a1" class="searchex_yuan_fixed_link searchex_yuan_fixed_on">1、<?php echo $yuyan2['text21'] ?></a>
								<a href="#a2" class="searchex_yuan_fixed_link">2、<?php echo $yuyan2['text22'] ?></a>
							</div>
						</div>
					</div>
