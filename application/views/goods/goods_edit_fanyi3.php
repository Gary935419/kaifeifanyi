    ...
    <div class="layui-row">
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="text13" name="text13" lay-verify="text13"
            ...
            $("#tab").validate({
                submitHandler: function (form) {
                    $.ajax({
                        cache: true,
                        type: "POST",
                        url: "<?= RUN . '/goods/goods_save_edit_fanyi3' ?>",
                        data: $('#tab').serialize(),
                        async: false,
