            ...
            $("#tab").validate({
                submitHandler: function (form) {
                    $.ajax({
                        cache: true,
                        type: "POST",
                        url: "<?= RUN . '/goods/goods_save_edit_fanyi1' ?>",
                        data: $('#tab').serialize(),
                        async: false,
